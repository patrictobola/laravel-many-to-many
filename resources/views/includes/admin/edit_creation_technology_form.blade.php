<div class="container">
    ...
    @if (Route::is('admin.technologies.create'))
    ...
    <div class="mb-3">
        ...
        <input type="text"
            ...
            id="label" name="label" value="{{ old('label', $technology->label ?? '') }}">
        @error('label')
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="{{ route('admin.technologies.index') }}" class="btn btn-info">Back to main page</a>
